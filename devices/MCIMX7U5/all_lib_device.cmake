...
#set.board.evkmcimx7ulp
#  # description: Board_project_template evkmcimx7ulp
#  set(CONFIG_USE_BOARD_Project_Template_evkmcimx7ulp true)

#set.device.MCIMX7U5
#  # description: Device MCIMX7U5_startup
#  set(CONFIG_USE_device_MCIMX7U5_startup true)

#  # description: Mcimx7ux_imgutil
#  set(CONFIG_USE_component_MCIMX7Ux_imgutil true)
...
#  # description: Evkmcimx7ulp_demobin
#  set(CONFIG_USE_component_evkmcimx7ulp_demobin true)

#  # description: Devices_project_template MCIMX7U5
#  set(CONFIG_USE_DEVICES_Project_Template_MCIMX7U5 true)

#  # description: Device MCIMX7U5_cmsis
...
#  set(CONFIG_USE_driver_ltc_edma true)
...
#  # description: XRDC Driver
#  set(CONFIG_USE_driver_xrdc true)
...
#  # description: RPMsg-Lite for evkmcimx7ulp_m4 baremetal application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_imx7ulp_m4_bm true)

#  # description: RPMsg-Lite for evkmcimx7ulp_m4 FreeRTOS application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_imx7ulp_m4_freertos true)

#  # description: RPMsg-Lite baremetal for evkmcimx7ulp board
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_bm_config_imx7ulp_m4 true)
...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/evkmcimx7ulp/demo_apps
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/evkmcimx7ulp/project_template
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../tools/imgutil
...
include_if_use(BOARD_Project_Template_evkmcimx7ulp)
...
include_if_use(DEVICES_Project_Template_MCIMX7U5.MCIMX7U5)
include_if_use(RTE_Device.MCIMX7U5)
include_if_use(component_MCIMX7Ux_imgutil.MCIMX7U5)
include_if_use(component_audio_sai_edma_adapter.MCIMX7U5)
include_if_use(component_button.MCIMX7U5)
include_if_use(component_codec_adapters.MCIMX7U5)
include_if_use(component_codec_i2c.MCIMX7U5)
include_if_use(component_common_task)
include_if_use(component_crc_adapter.MCIMX7U5)
include_if_use(component_da7212_adapter.MCIMX7U5)
include_if_use(component_evkmcimx7ulp_demobin.MCIMX7U5)
include_if_use(component_gpio_adapter.MCIMX7U5)
include_if_use(component_led.MCIMX7U5)
include_if_use(component_lists.MCIMX7U5)
include_if_use(component_log.MCIMX7U5)
include_if_use(component_log_backend_debugconsole.MCIMX7U5)
include_if_use(component_log_backend_debugconsole_lite.MCIMX7U5)
include_if_use(component_log_backend_ringbuffer.MCIMX7U5)
include_if_use(component_lpi2c_adapter.MCIMX7U5)
include_if_use(component_lpit_adapter.MCIMX7U5)
include_if_use(component_lpspi_adapter.MCIMX7U5)
include_if_use(component_lptmr_adapter.MCIMX7U5)
include_if_use(component_lpuart_adapter.MCIMX7U5)
include_if_use(component_lpuart_dma_adapter.MCIMX7U5)
include_if_use(component_mem_manager.MCIMX7U5)
include_if_use(component_mem_manager_light.MCIMX7U5)
...
include_if_use(component_panic.MCIMX7U5)
include_if_use(component_pwm_tpm_adapter.MCIMX7U5)
include_if_use(component_reset_adapter.MCIMX7U5)
include_if_use(component_serial_manager.MCIMX7U5)
include_if_use(component_serial_manager_spi.MCIMX7U5)
include_if_use(component_serial_manager_swo.MCIMX7U5)
include_if_use(component_serial_manager_uart.MCIMX7U5)
include_if_use(component_serial_manager_virtual.MCIMX7U5)
include_if_use(component_sgtl_adapter.MCIMX7U5)
include_if_use(component_software_crc_adapter.MCIMX7U5)
include_if_use(component_software_rng_adapter.MCIMX7U5)
include_if_use(component_timer_manager.MCIMX7U5)
include_if_use(component_tpm_adapter.MCIMX7U5)
include_if_use(component_trng_adapter.MCIMX7U5)
include_if_use(component_wm8960_adapter.MCIMX7U5)
include_if_use(device_MCIMX7U5_CMSIS.MCIMX7U5)
include_if_use(device_MCIMX7U5_startup.MCIMX7U5)
include_if_use(driver_acmp.MCIMX7U5)
include_if_use(driver_cache_lmem.MCIMX7U5)
include_if_use(driver_clock.MCIMX7U5)
include_if_use(driver_cmsis_lpi2c.MCIMX7U5)
include_if_use(driver_cmsis_lpspi.MCIMX7U5)
include_if_use(driver_cmsis_lpuart.MCIMX7U5)
include_if_use(driver_codec.MCIMX7U5)
include_if_use(driver_common.MCIMX7U5)
include_if_use(driver_crc.MCIMX7U5)
include_if_use(driver_dac12.MCIMX7U5)
include_if_use(driver_dialog7212.MCIMX7U5)
include_if_use(driver_dmamux.MCIMX7U5)
include_if_use(driver_edma.MCIMX7U5)
include_if_use(driver_ewm.MCIMX7U5)
include_if_use(driver_flexio.MCIMX7U5)
include_if_use(driver_flexio_camera.MCIMX7U5)
include_if_use(driver_flexio_camera_edma.MCIMX7U5)
include_if_use(driver_flexio_i2c_master.MCIMX7U5)
include_if_use(driver_flexio_i2s.MCIMX7U5)
include_if_use(driver_flexio_i2s_edma.MCIMX7U5)
include_if_use(driver_flexio_mculcd.MCIMX7U5)
include_if_use(driver_flexio_mculcd_edma.MCIMX7U5)
include_if_use(driver_flexio_spi.MCIMX7U5)
include_if_use(driver_flexio_spi_edma.MCIMX7U5)
include_if_use(driver_flexio_uart.MCIMX7U5)
include_if_use(driver_flexio_uart_edma.MCIMX7U5)
include_if_use(driver_fxos8700cq.MCIMX7U5)
include_if_use(driver_gpio.MCIMX7U5)
include_if_use(driver_iomuxc.MCIMX7U5)
include_if_use(driver_llwu.MCIMX7U5)
include_if_use(driver_lpadc.MCIMX7U5)
include_if_use(driver_lpi2c.MCIMX7U5)
include_if_use(driver_lpi2c_edma.MCIMX7U5)
include_if_use(driver_lpi2c_freertos.MCIMX7U5)
include_if_use(driver_lpit.MCIMX7U5)
include_if_use(driver_lpspi.MCIMX7U5)
include_if_use(driver_lpspi_edma.MCIMX7U5)
include_if_use(driver_lpspi_freertos.MCIMX7U5)
include_if_use(driver_lptmr.MCIMX7U5)
include_if_use(driver_lpuart.MCIMX7U5)
include_if_use(driver_lpuart_edma.MCIMX7U5)
include_if_use(driver_lpuart_freertos.MCIMX7U5)
include_if_use(driver_ltc.MCIMX7U5)
include_if_use(driver_ltc_edma.MCIMX7U5)
include_if_use(driver_msmc.MCIMX7U5)
include_if_use(driver_mu.MCIMX7U5)
include_if_use(driver_pf1550.MCIMX7U5)
include_if_use(driver_pmc0.MCIMX7U5)
include_if_use(driver_port.MCIMX7U5)
include_if_use(driver_qspi.MCIMX7U5)
include_if_use(driver_qspi_edma.MCIMX7U5)
include_if_use(driver_sai.MCIMX7U5)
include_if_use(driver_sai_edma.MCIMX7U5)
include_if_use(driver_sema42.MCIMX7U5)
include_if_use(driver_sgtl5000.MCIMX7U5)
include_if_use(driver_snvs_hp.MCIMX7U5)
include_if_use(driver_snvs_lp.MCIMX7U5)
include_if_use(driver_srtm.MCIMX7U5)
include_if_use(driver_srtm_freertos.MCIMX7U5)
include_if_use(driver_tpm.MCIMX7U5)
include_if_use(driver_trgmux.MCIMX7U5)
include_if_use(driver_trng.MCIMX7U5)
include_if_use(driver_tstmr.MCIMX7U5)
include_if_use(driver_wdog32.MCIMX7U5)
include_if_use(driver_wm8960.MCIMX7U5)
include_if_use(driver_xrdc.MCIMX7U5)
include_if_use(middleware_baremetal.MCIMX7U5)
...
include_if_use(middleware_issdk_algorithms_pedometer_common)
include_if_use(middleware_issdk_algorithms_pedometer_lib_cm4)
include_if_use(middleware_issdk_algorithms_sensor_fusion_agm01_common)
include_if_use(middleware_issdk_algorithms_sensor_fusion_agm04_common)
include_if_use(middleware_issdk_algorithms_sensor_fusion_agmp03_common)
include_if_use(middleware_issdk_algorithms_sensor_fusion_lpc_agm01_common)
include_if_use(middleware_issdk_algorithms_sensor_fusion_lpc_agmp03_common)
include_if_use(middleware_issdk_algorithms_sensor_fusion_mult2b_common)
...
include_if_use(middleware_multicore_rpmsg_lite_bm_config_imx7ulp_m4)
include_if_use(middleware_multicore_rpmsg_lite_freertos)
include_if_use(middleware_multicore_rpmsg_lite_freertos_config_imx7ulp_m4)
include_if_use(middleware_multicore_rpmsg_lite_imx7ulp_m4_bm)
include_if_use(middleware_multicore_rpmsg_lite_imx7ulp_m4_freertos)
...
include_if_use(utilities_misc_utilities.MCIMX7U5)
include_if_use(utility_assert.MCIMX7U5)
include_if_use(utility_assert_lite.MCIMX7U5)
include_if_use(utility_debug_console.MCIMX7U5)
include_if_use(utility_debug_console_lite.MCIMX7U5)
include_if_use(utility_notifier.MCIMX7U5)
include_if_use(utility_shell.MCIMX7U5)
include_if_use(utility_str.MCIMX7U5)
